...
public class FirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog.show();
        Log.d("FirstActivity", "LoadingDialog shown");

        userLocalStore = new UserLocalStore(this);
        user = userLocalStore.getLoggedInUser();

        FirebaseMessaging.getInstance().setAutoInitEnabled(true);
        Log.d("FirstActivity", "FirebaseMessaging initialized");
        ...
        if (!user.getMemberid().isEmpty()) {
            ...
            Log.d("FirstActivity", "User is logged in. Making dashboard API call.");
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, vurl, null, new Response.Listener<JSONObject>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e("FirstActivity", "Version API error: " + error.toString());
                ...
                if(response != null && response.data != null) {
                    ...
                    Log.e("FirstActivity", "Error Response Data: " + errorMsg);

                }
                if (error instanceof ServerError) {
                    // Handle server error
                    Log.e("ServerError", "Specific error message for ServerError");
                    if (!TextUtils.isEmpty(errorMsg)) {
                        Log.e("ServerErrorDetails", "Server-side error details: " + errorMsg);
                    }
                }
                    Log.e("errorversion",    error.toString() + "hello");
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
            ...
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
                Log.d("FirstActivity", "Setting headers for Version API request.");
                Map<String, String> headers = new HashMap<>();
